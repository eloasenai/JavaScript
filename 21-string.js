...
// var texto4 = " Olá, meu nome é Eloa!";
// console.log(`Tamanho do texto: ${texto.length} caracteres!`);

// //Caracteres de escape
// var texto5 = 'Olá, meu nome é "Eloa"!';
// console.log(texto5);
...
// var sub = texto8.substring(10, 4); //posição onde começa e onde termina
// console.log(sub);
// var sub2 = texto8.substr(10, 4); // posição onde começa e quantos caracteres
// console.log(sub2);

// //substituir partes de um stings ( estudo reptção)
...
// //maiusculas e minusculas em branco (Metodo trim )
